                    ...
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="item-1" className="border-none">
                        ...
                        <AccordionContent className="text-left">
                          ...
                          ZetaChain that helps you track and manage your assets
                      ...
                      <AccordionItem value="item-2" className="border-none">
                        ...
                        <AccordionContent className="text-left">
                          Click the &quot;Connect Wallet&quot; button above and
                          select your preferred wallet from the list of
                      ...
                      <AccordionItem value="item-3" className="border-none">
                        ...
                        <AccordionContent className="text-left">
                          Porkfolio supports both ZetaChain mainnet and testnet.
                          You can switch between networks in the settings after
