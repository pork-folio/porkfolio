  ...
  return (
    <>
      <div className="flex min-h-screen flex-col bg-background">
        <div className="flex-none py-6 mt-40 text-center">
                      ...
                      <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1" className="border-none">
                          ...
                          <AccordionContent className="text-left">
                            Porkfolio is a portfolio management platform for
                            ZetaChain that helps you track and manage your
                        ...
                        <AccordionItem value="item-2" className="border-none">
                          ...
                          <AccordionContent className="text-left">
                            ...
                            and select your preferred wallet from the list of
                            supported options. Make sure you have a compatible
                            wallet installed in your browser.
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3" className="border-none">
                          ...
                          <AccordionContent className="text-left">
                            Porkfolio supports both ZetaChain mainnet and
                            testnet. You can switch between networks in the
                            settings after connecting your wallet.
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-4" className="border-none">
                          ...
                          <AccordionContent className="text-left">
                            Once connected, your portfolio will automatically
                            display all your assets across supported chains. You
                            can refresh the data using the refresh button in the
                            top right corner.
                          </AccordionContent>
                        </AccordionItem>
                      </Accordion>
                            ...
                            <div className="px-4 lg:px-6">
                              <div className="flex items-center justify-between">
                                ...
                                <Button
                                  ...
                                  disabled={
                                    isRefreshing || !primaryWallet?.address
                                  }
                                >
                                  <IconRefresh
                                    className={cn(
